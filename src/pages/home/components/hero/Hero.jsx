		...
		<main className="Hero" data-aos={"zoom"} data-aos-duration={1000}>
			<div className="Hero-item-fx">
				<HeroHeader
					...
					subtitle={
						"Pricify es una aplicación web gratuita e innovadora diseñada para facilitar la gestión y el cálculo de precios de manera rápida y eficiente"
					}
				/>
				...
				<div className="Hero-checks">
					<ItemCheck p={"Acceso a calculadoras de porcentajes"} />
