        ...
        <>
            <SectionLayout>
                <div className={styles.content}>
                    ...
                    <p className={styles.text}>Ingresa el costo de tu producto y el margen que queres ganar. Pricify calcula al instante el precio de venta ideal y la ganancia neta, sin fórmulas ni hojas de cálculos.</p>
                </div>
            ...
            <SectionLayout direction={'row_reverse'}>
                <div className={styles.content}>
                    ...
                    <h2>Gestiona tu lista de precios.</h2>
